...
AWGM_VARIANT="${AWGM_VARIANT:-w8m_diag4_subband_shared}"
RUNTIME_LOG="$PROJECT_ROOT/runs/experiment_a_v2/w8m_queue_runtime.tsv"
...
if [[ ! -f "$RUNTIME_LOG" ]]; then
  printf 'timestamp\tid\tdataset\tmodel_variant\tawgm_variant\tgpu\tpid\toutput_dir\n' > "$RUNTIME_LOG"
fi
