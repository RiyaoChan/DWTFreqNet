...
调度器 PID：`3092160`，启动时间：`2026-07-12 21:00:10 +08:00`。
...
|---|---|---|---:|---:|---|---|
| B0-NUAA | NUAA-SIRST | sd_raw | 1 | 3092182 | 运行中，epoch 17 | `runs/experiment_b/NUAA-SIRST/sd_raw/seed42` |
| B1-NUAA | NUAA-SIRST | sd_awgm | 4 | 3092264 | 运行中，epoch 15 | `runs/experiment_b/NUAA-SIRST/sd_awgm/seed42` |
| B2-NUAA | NUAA-SIRST | sd_pyramid | 6 | 3092353 | 运行中，epoch 13 | `runs/experiment_b/NUAA-SIRST/sd_pyramid/seed42` |
