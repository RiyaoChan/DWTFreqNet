...
|---:|---|---|---|---|---|
| 1 | F1 | NUAA-SIRST | `F1_multiscale/NUAA-SIRST/seed42` | 待分配 | 待启动 |
| 2 | F4 | NUAA-SIRST | `F4_low_guided_full/NUAA-SIRST/seed42` | 待分配 | 待启动 |
| 3 | F2 | NUAA-SIRST | `F2_sparse/NUAA-SIRST/seed42` | 待分配 | 待启动 |
| 4 | F3 | NUAA-SIRST | `F3_cross_direction/NUAA-SIRST/seed42` | 待分配 | 待启动 |
| 5 | F1 | IRSTD-1K | `F1_multiscale/IRSTD-1K/seed42` | 待分配 | 待启动 |
| 6 | F4 | IRSTD-1K | `F4_low_guided_full/IRSTD-1K/seed42` | 待分配 | 待启动 |
