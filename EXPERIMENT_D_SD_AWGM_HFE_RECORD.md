...
| NUAA-SIRST | `sd_awgm_hfe` | GPU1训练中（当前 epoch 992） | 286 | 0.7747 | 0.7809 | 0.8731 | 0.9695 | 2.394e-5 | 10.181M | 20.47G | 28.17ms |
| NUDT-SIRST | `sd_awgm` | 已有结果 | 556 | 0.9058 | 0.9019 | 0.9505 | 0.9852 | 4.182e-6 | 5.926M | 14.38G | 5.15ms |
| NUDT-SIRST | `sd_awgm_hfe` | GPU0训练中（当前 epoch 369） | 318 | 0.9429 | 0.9455 | 0.9706 | 0.9947 | 2.045e-6 | 10.181M | 20.47G | 28.17ms |
| IRSTD-1K | `sd_awgm` | 已有结果 | 894 | 0.6561 | 0.6477 | 0.7924 | 0.9091 | 1.537e-5 | 5.926M | 14.38G | 5.15ms |
| IRSTD-1K | `sd_awgm_hfe` | GPU3训练中（当前 epoch 411） | 311 | 0.6488 | 0.6261 | 0.7870 | 0.9226 | 3.522e-5 | 10.181M | 20.47G | 28.17ms |
...
### 8.1 阶段性结果快照（2026-07-14 22:21:19 CST）
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| NUDT-SIRST | 0 | 369 | 318 | 0.9429 | 0.9455 | 0.9706 | 0.9947 | 2.045e-6 |
| NUAA-SIRST | 1 | 992 | 286 | 0.7747 | 0.7809 | 0.8731 | 0.9695 | 2.394e-5 |
| IRSTD-1K | 3 | 411 | 311 | 0.6488 | 0.6261 | 0.7870 | 0.9226 | 3.522e-5 |

## 9. Decoder HFE Matching 内部消融（D2 → D3）

已在独立分支 `codex/experiment-d-hfe-matching-ablation-d2-d3` 实现 D2/D3。
D2 将四尺度 Hard L2 Top-1 替换为 Soft Cosine Top-k；D3 只将浅层 Stage 1/2
改为 Local Correlation Gate，Stage 3/4 与 D2 完全相同。D2 和 D3 都属于
