...
| 诊断 | 状态 | 输出 |
|---|---|---|
| A1/A2 算子忠实度与低频source错配 | NUAA train运行中，GPU 5，修复后launcher PID `964196`；其余任务由服务器队列等待空闲GPU | C_P2/C_square/C_GR、四source、四stage |
| A3/A4 stage/rho反事实与Gate强度 | 待运行 | source×operator×stage集合×rho、阈值0.1–0.9 |
| A5 Gaussian处理效应 | 待运行 | Gaussian-on/off局部Delta loss/IoU/概率/Fa |
| A6 先验反馈漂移 | 等同数据集A1/A2完成后运行 | gap/AUC/分布漂移、逐样本D_feat与stop-gradient审计 |
...
|---|---|---:|---:|---:|---|
| K2 | NUAA-SIRST | 3 | 952684 | 952691 | 运行，epoch 117/1000 |
| K2 | IRSTD-1K | 4 | 952888 | 952895 | 运行，epoch 33/1000；尚未到评估起点 |
