...
A6每个数据集完成240组gap/AUC/分布比较，并记录NUAA `17,040`条、IRSTD `64,000`条逐样本`D_feat`。最大中位`D_feat`分别为NUAA `0.9922`和IRSTD `1.9517`；IRSTD最大漂移出现在J2-D的Stage3 LFSS LL。该结果支持K正式实现始终对Compactness source使用stop-gradient。
...
|---|---|---:|---:|---:|---|
| K2 | NUAA-SIRST | 3 | 952684 | 952691 | 运行，epoch 784/1000 |
| K2 | IRSTD-1K | 4 | 952888 | 952895 | 运行，epoch 262/1000 |
...
`2026-07-23 08:48:59 CST`快照：

- NUAA当前epoch 784，当前mIoU/nIoU/F1/Pd/Fa为`0.798244/0.794385/0.887804/0.969466/2.79891e-05`；best仍位于epoch 607，为`0.801101/0.795325/0.889568/0.965649/2.54509e-05`。
- IRSTD当前epoch 262，当前mIoU/nIoU/F1/Pd/Fa为`0.616165/0.620903/0.762502/0.882155/2.17305e-05`；best仍位于epoch 158，为`0.649640/0.603540/0.787614/0.892256/2.67978e-05`。
