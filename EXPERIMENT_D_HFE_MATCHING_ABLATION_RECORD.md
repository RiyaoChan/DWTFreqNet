...
| NUDT | D4 | `sd_awgm_hfe_nomatch` | Direct Low Fusion | Direct Low Fusion | 441 | 0.944108 | 0.946479 | 0.971251 | 0.988360 | 3.033e-6 | 已完成1000 epoch |
...
D2/D3/D4 的三个数据集最终均训练至 1000 epoch。从 epoch 100 起每个 epoch
评估并按 mIoU 保存最佳 checkpoint。

### 9.1 D4 最终结果快照（2026-07-17）

上述 D4 指标来自服务器最终 `best_metrics.json`；三个任务日志的最新 epoch 均为
1000。
...
|---:|---|---:|---:|---:|---|---|
| 1 | NUAA-SIRST | 3 | 1248701 | 1248711 | `runs/experiment_d_ablation/D4_no_matching/NUAA-SIRST/seed42` | 已完成1000 epoch |
| 2 | IRSTD-1K | 4 | 1248780 | 1248790 | `runs/experiment_d_ablation/D4_no_matching/IRSTD-1K/seed42` | 已完成1000 epoch |
| 3 | NUDT-SIRST | 5 | 1248865 | 1248871 | `runs/experiment_d_ablation/D4_no_matching/NUDT-SIRST/seed42` | 已完成1000 epoch |
...
## 12. Experiment D 空间消融最新记录（2026-07-17 16:26 CST）

D5、D6、D7 的最新三数据集指标已从 226 服务器回填；D5/D6 三数据集及 D7 的
NUAA、IRSTD 均已完成 1000 epoch。D7/NUDT 按用户要求在 epoch888 停止，停止前
最佳为 epoch840：mIoU 0.943812、nIoU 0.947057、F1 0.971094、Pd 0.992593、
Fa 1.976e-6；该行明确标记为未完成1000 epoch。完整指标表及停止信息见
