...
从 epoch 100 开始逐 epoch 评估；截至 2026-07-14 22:18:22 CST 尚未全部完成，
下表为当前 `best_metrics.json` 的阶段性最佳结果（Fa 为原始比例）：

| 数据集 | 当前 epoch | 最佳 epoch | mIoU | nIoU | F1 | Pd | Fa |
|---|---:|---:|---:|---:|---:|---:|---:|
| NUAA-SIRST | 981 | 286 | 0.7747 | 0.7809 | 0.8731 | 0.9695 | 2.394e-5 |
| NUDT-SIRST | 365 | 318 | 0.9429 | 0.9455 | 0.9706 | 0.9947 | 2.045e-6 |
| IRSTD-1K | 406 | 311 | 0.6488 | 0.6261 | 0.7870 | 0.9226 | 3.522e-5 |
