...
> 状态：代码、服务器 CUDA/真实数据验证和 RTX 3090 复杂度测试均已完成；15 项正式训练队列已启动，当前 3 项运行、12 项等待。严禁用占位值冒充实验结果。
...
|---|---|---|---|---|---|
| NUAA-SIRST | 运行：GPU 1，wrapper/python `3890074/3890083`，epoch 2 | 运行：GPU 2，`3890291/3890300`，epoch 2 | 运行：GPU 3，`3890606/3890615`，epoch 1 | 等待 | 等待 |
