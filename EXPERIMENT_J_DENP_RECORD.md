...
|---|---|---|---|---|---|
| NUAA-SIRST | **完成1000** | **完成1000** | **完成1000** | GPU 4：epoch 975 | GPU 0重跑：epoch 258，best 248 |
| IRSTD-1K | GPU 6：epoch 397，best 354 | GPU 1：epoch 52 | GPU 2：epoch 48 | GPU 3：epoch 32 | 待启动 |
| NUDT-SIRST | 待启动 | 待启动 | 待启动 | 待启动 | 待启动 |

状态更新时间：`2026-07-21 23:51`（Asia/Shanghai）。队列PID `3889915` 正常存活；当前6项运行、3项完成、6项排队，另保留J3-R–NUAA的首次失败归档。J3-R重跑已于22:32在GPU 0启动；IRSTD的J2-R/J2-D/J3-F已分别在GPU 1/2/3启动。运行时权重不提交GitHub。
...
下列 E1/J0 是既有基线，不是本轮重复训练结果。表中所有数值均为截至 `2026-07-21 23:51` 从各正式运行目录读取：当前epoch来自 `metrics.jsonl` 的最后一条记录，best epoch及五项指标来自 `best_metrics.json`。没有产生best文件的任务明确标记为“运行未评估”或“待训练”，不会用当前epoch指标冒充best。
...
| NUAA | J3-F | 运行 | 975 | 568 | 0.7944 | 0.7941 | 0.8854 | **0.9771** | 3.608e-5 |
| NUAA | J3-R | 重跑运行 | 258 | 248 | 0.7658 | 0.7790 | 0.8673 | 0.9618 | 2.922e-5 |
| IRSTD | E1/J0 | 基线 | 1000 | 551 | 0.6647 | 0.6630 | 0.7985 | 0.9158 | 1.230e-5 |
| IRSTD | J1 | 运行 | 397 | 354 | 0.6494 | 0.6381 | 0.7874 | 0.8990 | 1.141e-5 |
| IRSTD | J2-R | 运行未评估 | 52 | — | — | — | — | — | — |
| IRSTD | J2-D | 运行未评估 | 48 | — | — | — | — | — | — |
| IRSTD | J3-F | 运行未评估 | 32 | — | — | — | — | — | — |
| IRSTD | J3-R | 待训练 | — | — | — | — | — | — | — |
