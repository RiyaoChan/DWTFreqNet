...
> 状态：代码、服务器 CUDA/真实数据验证和 RTX 3090 复杂度测试均已完成；15 项正式训练队列持续运行。截至2026-07-23 08:48，12项已完成1000 epoch，剩余NUDT的J2-D、J3-F、J3-R三项正在运行，当前无排队任务。J3-R首次失败输出已独立归档，修正设备校验后的自动重跑已完成。所有表格数值直接来自对应 `best_metrics.json`，严禁用占位值或当前epoch指标冒充best。
...
|---|---|---|---|---|---|
| NUAA-SIRST | **完成1000** | **完成1000** | **完成1000** | **完成1000** | **重跑完成1000** |
| IRSTD-1K | **完成1000，best 441** | **完成1000，best 668** | **完成1000，best 635** | **完成1000，best 613** | **完成1000，best 878** |
| NUDT-SIRST | **完成1000，best 646** | **完成1000，best 642** | 运行：epoch 916，best 523 | 运行：epoch 609，best 548 | 运行：epoch 597，best 490 |

状态更新时间：`2026-07-23 08:48`（Asia/Shanghai）。队列PID `3889915` 正常存活；当前3项运行、12项完成、0项排队，另保留J3-R–NUAA的首次失败归档。NUAA与IRSTD各五个变体均已完成1000 epoch，其中NUAA-J3-R自动重跑也已正常完成；NUDT-J1和J2-R已完成，J2-D、J3-F和J3-R分别在GPU 6、1、2上运行。运行时权重不提交GitHub。
...
下列 E1/J0 是既有基线，不是本轮重复训练结果。表中所有数值均为截至 `2026-07-23 08:48` 从各正式运行目录读取：当前epoch来自 `metrics.jsonl` 的最后一条记录，best epoch及五项指标来自 `best_metrics.json`。运行中任务仅代表当前阶段best，不作为最终结果；未产生best文件的任务明确标记为“待训练”，不会用当前epoch指标冒充best。

| Dataset | Variant | 状态 | 当前epoch | Best epoch | mIoU | nIoU | F1 | Pd | Fa |
|---|---|---|---:|---:|---:|---:|---:|---:|---:|
| NUAA | E1/J0 | 基线 | 1000 | 595 | 0.7842 | 0.7960 | 0.8790 | 0.9656 | 2.717e-5 |
| NUAA | **J1** | **完成** | 1000 | **572** | **0.7962** | **0.8004** | **0.8865** | 0.9733 | **1.955e-5** |
| NUAA | J2-R | 完成 | 1000 | 658 | 0.7856 | 0.7956 | 0.8799 | 0.9618 | **1.825e-5** |
| NUAA | J2-D | 完成 | 1000 | 738 | 0.7882 | 0.7953 | 0.8816 | 0.9733 | 2.133e-5 |
| NUAA | J3-F | 完成 | 1000 | 568 | 0.7944 | 0.7941 | 0.8854 | **0.9771** | 3.608e-5 |
| NUAA | J3-R | 重跑完成 | 1000 | 298 | 0.7748 | 0.7822 | 0.8731 | 0.9542 | 2.312e-5 |
| IRSTD | E1/J0 | 基线 | 1000 | 551 | 0.6647 | 0.6630 | 0.7985 | 0.9158 | 1.230e-5 |
| IRSTD | **J1** | **完成** | 1000 | **441** | **0.6711** | 0.6372 | **0.8032** | 0.9125 | 2.970e-5 |
| IRSTD | J2-R | 完成 | 1000 | 668 | 0.6685 | **0.6687** | 0.8013 | 0.9226 | 1.120e-5 |
| IRSTD | J2-D | 完成 | 1000 | 635 | 0.6666 | 0.6605 | 0.8000 | 0.9091 | **8.445e-6** |
| IRSTD | J3-F | 完成 | 1000 | 613 | 0.6620 | 0.6588 | 0.7966 | **0.9360** | 1.236e-5 |
| IRSTD | J3-R | 完成 | 1000 | 878 | 0.6581 | 0.6597 | 0.7938 | 0.9259 | 1.245e-5 |
| NUDT | E1/J0 | 基线 | 1000 | 456 | 0.9516 | 0.9482 | 0.9752 | 0.9947 | 1.724e-6 |
| NUDT | J1 | 完成 | 1000 | 646 | 0.9506 | 0.9504 | 0.9747 | 0.9926 | 1.287e-6 |
| NUDT | J2-R | 完成 | 1000 | 642 | 0.9545 | 0.9556 | 0.9767 | 0.9915 | 1.310e-6 |
| NUDT | **J2-D** | 运行 | 916 | **523** | **0.9561** | **0.9563** | **0.9775** | 0.9915 | **9.881e-7** |
| NUDT | J3-F | 运行 | 609 | 548 | 0.9524 | 0.9518 | 0.9756 | 0.9926 | 2.298e-6 |
| NUDT | J3-R | 运行 | 597 | 490 | 0.9468 | 0.9473 | 0.9727 | 0.9926 | 3.677e-6 |
...
NUAA五项均已完成1000 epoch：J1最终best为 mIoU/nIoU/F1/Pd/Fa `0.7962/0.8004/0.8865/0.9733/1.955e-5`，相对E1/J0的mIoU提升 `0.0119`；J2-R取得最低Fa `1.825e-5`；J3-F取得最高Pd `0.9771`；J3-R自动重跑完成但mIoU仅为 `0.7748`，未优于J3-F或E1。IRSTD五项也已全部完成：J1取得最高mIoU/F1 `0.6711/0.8032`，J2-R取得最高nIoU `0.6687`，J2-D取得最低Fa `8.445e-6`，J3-F取得最高Pd `0.9360`；这些优势分别高于E1/J0对应的 `0.6647/0.7985`、`0.6630`、`1.230e-5`和`0.9158`。NUDT的J1与J2-R已经完成，J2-R最终best为`0.9545/0.9556/0.9767/0.9915/1.310e-6`；J2-D阶段best仍在epoch 523，为`0.9561/0.9563/0.9775/0.9915/9.881e-7`，当前是NUDT五个J变体中主指标最优。J3-F阶段best提升至epoch 548的`0.9524/0.9518/0.9756/0.9926/2.298e-6`，mIoU/nIoU/F1略高于E1/J0但Fa更高；J3-R阶段best为epoch 490的`0.9468/0.9473/0.9727/0.9926/3.677e-6`，仍未优于J3-F。NUDT剩余三项尚未完成，因此跨数据集Go/No-Go仍需等待最终结果与正式诊断。
