...
|---|---|---|---|---|---|
| NUAA-SIRST | 运行：GPU 1，wrapper/python `3890074/3890083` | 运行：GPU 2，`3890291/3890300` | 运行：GPU 3，`3890606/3890615` | 运行：GPU 4，`3916968/3916977` | 失败并保留：GPU 6，`3932397`；未自动重跑 |
| IRSTD-1K | 运行：GPU 6，`3936208/3936217` | 待启动 | 待启动 | 待启动 | 待启动 |
